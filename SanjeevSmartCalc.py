# main python program
response=['Welcome to Smart Calculator','My name is RAHUL',
          'Thanks for enjoy with me ','Sorry ,this is  beyond my ability','****..... Mast .....****']
...
operations={'ADD':add,'PLUS':add,'SUM':add,'ADDITION':add,
            ...
            'DIVISION':div,'DIVIDE':div,'MOD':mod,'REMANDER'
            :mod,'MODULAS':mod}
  
# commands
commands={'NAME':myname,'EXIT':end,'END':end,'CLOSE':end,'NAAM':myname,'HAAL':haal,'HAL':haal}
